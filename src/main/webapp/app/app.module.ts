...
import { TestGatewaySharedModule } from 'app/shared';
import { TestGatewayCoreModule } from 'app/core';
import { TestGatewayAppRoutingModule } from './app-routing.module';
import { TestGatewayHomeModule } from './home/home.module';
import { TestGatewayAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    ...
    TestGatewaySharedModule.forRoot(),
    TestGatewayCoreModule,
    TestGatewayHomeModule,
    TestGatewayAccountModule,

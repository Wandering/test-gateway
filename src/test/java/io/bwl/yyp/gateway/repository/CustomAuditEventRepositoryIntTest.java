package io.bwl.yyp.gateway.repository;

import io.bwl.yyp.gateway.TestGatewayApp;
import io.bwl.yyp.gateway.config.Constants;
import io.bwl.yyp.gateway.config.audit.AuditEventConverter;
import io.bwl.yyp.gateway.domain.PersistentAuditEvent;
...
import static io.bwl.yyp.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
